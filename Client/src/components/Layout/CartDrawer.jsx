  ...
  return (
    <div className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-1/4 h-full bg-white shadow-lg transform transition-transform duration-300 flex flex-col z-50 ${
        ...
        <div className='p-4 bg-white sticky bottom-0'>
            <button onClick={handleCheckoutOption} className='w-full rounded-md bg-green-700 text-black py-3 font-semibold hover:bg-green-500 transition'>Checkout</button>
